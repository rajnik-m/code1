...
#Region "Properties"
    ...
    Public ReadOnly Property ModifierPrice() As Double
      ...
      End Get
    End Property
    Public ReadOnly Property ModifierPerItem() As Boolean
      Get
        Return mvClassFields(PaymentPlanDetailPricingFields.ModifierPerItem).Bool
      End Get
    End Property
...
#End Region
    ...
    Public Sub InitWithModifierData(ByVal pRateModifier As RateModifier, ByVal pModifierActivityQuantity As Double, ByVal pModifierActivityDate As String, ByVal pModifierPrice As Double, ByVal pUnitPrice As Double)
      ...
      Else
        Dim vUnitPrice As Double = FixTwoPlaces(mvClassFields.Item(PaymentPlanDetailPricingFields.UnitPrice).DoubleValue + pUnitPrice)
        mvClassFields.ClearItems()
        'Set Values to 'Multiple'
        mvClassFields.Item(PaymentPlanDetailPricingFields.ModifierActivity).Value = "MULTI"
        mvClassFields.Item(PaymentPlanDetailPricingFields.ModifierActivityValue).Value = "MULT"
        mvClassFields.Item(PaymentPlanDetailPricingFields.ModifierPerItem).Value = "M"
        mvClassFields.Item(PaymentPlanDetailPricingFields.UnitPrice).DoubleValue = vUnitPrice
      End If
      mvExisting = True
    End Sub
