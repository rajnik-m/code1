Public Class EncryptionProvider
  ...
  Public Sub InitWithKey(ByVal pKeyValue As String)
    mvKey = pKeyValue
  End Sub
  ...
  Public Function Decrypt(ByRef pEncryptedString As String) As String
    ...
    RC4ini()
    For vIndex = 1 To pEncryptedString.Length Step 2
  ...
  Public Function Encrypt(ByRef pSource As String) As String
    ...
    For vIndex = 1 To vEncoded.Length
  ...
  Private Function GetHexPair(ByRef pChar As String) As String
    ...
    If vResult.Length = 1 Then vResult = "0" & vResult
    GetHexPair = vResult
  End Function
