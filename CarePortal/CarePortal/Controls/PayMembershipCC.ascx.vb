Partial Public Class PayMembershipCC
  ...
  Protected Overloads Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    Try
      ...
      InitialiseControls(CareNetServices.WebControlTypes.wctRenewMembershipCC, tblDataEntry, "CreditCardNumber,CardExpiryDate")
      ...
      If vTable IsNot Nothing Then
        For Each vRow As DataRow In vTable.Rows
          If vRow("MembershipType").ToString.Length > 0 Then
            ...
            mvMembershipTypeDesc = vRow("MembershipType").ToString
            Exit For
          End If
        Next
      End If
      If mvPaymentPlanNumber > 0 Then
        SetTextBoxText("MembershipTypeDesc", mvMembershipTypeDesc)
        SetTextBoxText("NextPaymentDue", mvNextPaymentDue)
        SetTextBoxText("NextPaymentAmount", mvNextPaymentAmount)
      Else
        ShowMessageOnly("You have no memberships that need payment at this time")
      End If
