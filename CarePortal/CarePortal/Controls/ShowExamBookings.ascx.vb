Public Class ShowExamBookings
  ...
  Protected Overloads Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    Try
      InitialiseControls(CareNetServices.WebControlTypes.wctShowExamBookings, tblDataEntry)
      ...
      End If
      Dim vDataGrid As DataGrid = TryCast(Me.FindControl("ExamBookingData"), DataGrid)
      If vDataGrid IsNot Nothing Then
        Dim vResult As String = DataHelper.FindData(CareNetServices.XMLDataFinderTypes.xdftWebExamBookings, vList)
