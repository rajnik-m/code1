Public Class MenuToolbarCommand
  ...
  Public Shared Function NewMenuItem(ByVal pItem As Integer, ByVal pText As String, ByVal pOnClick As System.EventHandler, Optional ByVal pName As String = "") As ToolStripMenuItem
    Return NewMenuItem(pItem, pText, Nothing, pOnClick, pName)
  End Function
  Public Shared Function NewMenuItem(ByVal pItem As Integer, ByVal pText As String, Optional ByVal pImage As Image = Nothing, Optional ByVal pOnClick As System.EventHandler = Nothing, Optional ByVal pName As String = "") As ToolStripMenuItem
  ...
  Public Shared Sub SetAccessControl(ByVal pMenuItems As CollectionList(Of MenuToolbarCommand), Optional ByVal pMainMenu As Boolean = False)
    Dim vMenuTable As DataTable = DataHelper.GetCachedLookupData(CareNetServices.XMLLookupDataTypes.xldtUserMenuAccess)
